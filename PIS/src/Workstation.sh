...
#Init of functions
  create_workstation_debian()
  {
    ...
    #Install langs c,c++,c#,python,perl, java, kotlin, dart, ruby, assembly and tools
      ...
      sudo dpkg -i packages-microsoft-prod.deb; sudo apt-get install aspnetcore-runtime-3.1; apt update; sudo apt-get install dotnet-runtime-3.1 -y;
      ...
      sudo apt-get update;  sudo apt-get install dart -y; export PATH="$PATH:/usr/lib/dart/bin";
